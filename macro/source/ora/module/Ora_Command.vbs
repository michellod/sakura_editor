...
Public Sub EntryPoint()
  ...
  Call Ora_Init(lstr_ResultCode,lstr_Message)
  
  Dim lstr_SelectedString
  lstr_SelectedString = Editor.GetSelectedString(0)
  
  Call Ora.Command.Operate(lstr_ResultCode, lstr_Message, lstr_SelectedString)
  MsgBox lstr_Message
...
Private Sub LoadLibraries_(ByRef ostr_ResultCode,ByRef ostr_Message)
  ...
  Const lstr_LIBRARY_LIST_FILE_NAME = "ora_libraries.lst"
